        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:pt-24 lg:pb-40">
          ...
          <div className="mx-auto max-w-screen-xl w-full text-center">
            <h1 className="text-5xl max-w-xl mx-auto">
              Meet <span className="font-bold leading-snug">Everyone</span> who
            ...
            <div className="group relative block bg-black">
              ...
              <div className="relative p-4 sm:p-6 lg:p-8">
                ...
                <div className="mt-32 sm:mt-48 lg:mt-64">
                  <div className="translate-y-8 transform opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100 group-hover:duration-500">
