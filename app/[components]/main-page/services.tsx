    ...
    <>
      <section className="bg-darkpint text-white">
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          ...
          <div className="grid grid-cols-5 gap-8 mb-16 items-center">
          ...
          <div>
            <div className="grid grid-cols-5 gap-8 items-center py-8 w-full">
            ...
            <div className="grid grid-cols-5 gap-8 items-center py-8">
