    ...
    <>
      ...
      >
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 z-10 relative">
          ...
          <div className="grid grid-cols-2 gap-4 items-center py-8 w-full">
            <div className="group relative block overflow-hidden rounded-xl bg-darkpint">
              <div className="relative h-64">
                <Image
                  ...
                  width={500}
                  height={500}
                  className="w-full h-full object-cover transition-all duration-500 group-hover:scale-105 opacity-100 group-hover:opacity-30"
                />
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <div className="translate-y-16 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                      ...
                      <p className="text-sm text-white max-w-md">
                        Sea Freight is a method of transporting large amounts of
                        goods using carrier ships.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="text-center">
                    <div className="translate-y-16 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                      ...
                      <p className="text-sm text-white max-w-md">
                        ...
                        combining several types of transportation to send goods
                        that are difficult to reach by general transportation
                      </p>
                    </div>
                  </div>
                </div>
