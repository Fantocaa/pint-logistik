...
export default function ServicesTab() {
  return (
    ...
    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-12 lg:px-8 lg:py-36">
      <div className="mx-auto text-center">
        <h1 className="text-xl pb-4">Our Services</h1>
        <p className="text-2xl md:text-6xl font-bold pb-8 md:pb-16 max-w-xl text-center mx-auto">
          We Provide Best{" "}
      ...
      >
        <div className="flex w-full h-full flex-col gap-4">
          ...
          <TabsContent value="road">
            <article className="relative overflow-hidden rounded-lg shadow transition hover:shadow-lg h-[27rem]">
              <Image
                alt="roading"
                src="/images/roading.png"
                className="absolute inset-0 w-full h-full object-cover object-center"
                ...
                height={1080}
              />
              <div className="relative pt-4 md:pt-24 bg-gradient-to-t from-gray-900 to-slate-900/5 h-full">
                <div className="p-4 sm:p-6">
                  <div>
                    <h3 className="mt-0.5 text-white font-bold text-xl md:text-4xl">
                      Road Freight
          ...
          <TabsContent value="sea">
            <article className="relative overflow-hidden rounded-lg shadow transition hover:shadow-lg h-96">
              <Image
                ...
                height={1080}
              />
              <div className="relative pt-60 md:pt-56 bg-gradient-to-t from-slate-900 to-slate-900/5 h-full">
                <div className="p-4 sm:p-6">
                  <div>
                    <h3 className="mt-0.5 text-white font-bold text-xl md:text-4xl">
                      Sea Freight
          ...
          <TabsContent value="multimoda">
            <article className="relative overflow-hidden rounded-lg shadow transition hover:shadow-lg h-96">
              <Image
                ...
                height={1080}
              />
              <div className="relative pt-48 md:pt-48 bg-gradient-to-t from-gray-900 to-slate-900/5 h-full">
                <div className="p-4 sm:p-6">
                  <div>
                    <h3 className="mt-0.5 text-white font-bold text-xl md:text-4xl">
                      Multimoda
