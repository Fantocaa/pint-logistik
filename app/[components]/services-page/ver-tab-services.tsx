  ...
  return (
    ...
    <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-36">
      <div className="mx-auto text-center">
        ...
        <p className="text-6xl font-bold pb-16 max-w-xl text-center mx-auto">
          We Provide Best{" "}
      ...
      >
        <div className="flex w-full h-full">
          <TabsList className="flex flex-col mr-8 h-full py-8 px-4 ">
            <TabsTrigger
              value="road"
              className="px-24 py-4 text-gray-600 text-left"
            >
              <h1 className="">Road Freight</h1>
            </TabsTrigger>
            <TabsTrigger value="sea" className="px-24 py-4 text-gray-600">
              Sea Freight
            </TabsTrigger>
            <TabsTrigger value="multimoda" className="px-24 py-4 text-gray-600">
              Multimoda
            </TabsTrigger>
            <TabsTrigger value="trailer" className="px-24 py-4 text-gray-600">
              Armada Trailer
            </TabsTrigger>
          </TabsList>
          <TabsContent value="road">
            <article className="relative overflow-hidden rounded-lg shadow transition hover:shadow-lg h-96">
              <Image
                ...
                height={1080}
              />
              <div className="relative pt-56 bg-gradient-to-t from-gray-900 to-slate-900/5 h-full">
                <div className="p-4 sm:p-6">
                  <div>
                    <h3 className="mt-0.5 text-white font-bold text-4xl">
                      Road Freight
                    </h3>
                  </div>

                  <p className="mt-2 line-clamp-3 text-lg/relaxed text-white/95 ">
          ...
          <TabsContent value="sea">
            <article className="relative overflow-hidden rounded-lg shadow transition hover:shadow-lg h-96">
              <Image
                ...
                height={1080}
              />
              <div className="relative pt-56 bg-gradient-to-t from-slate-900 to-slate-900/5 h-full">
                <div className="p-4 sm:p-6">
                  <div>
                    <h3 className="mt-0.5 text-white font-bold text-4xl">
                      Sea Freight
          ...
          <TabsContent value="multimoda">
            <article className="relative overflow-hidden rounded-lg shadow transition hover:shadow-lg h-96">
              <Image
                ...
                height={1080}
              />
              <div className="relative pt-48 bg-gradient-to-t from-gray-900 to-slate-900/5 h-full">
                <div className="p-4 sm:p-6">
                  <div>
                    <h3 className="mt-0.5 text-white font-bold text-4xl">
                      Multimoda
          ...
          <TabsContent value="trailer">
            <article className="relative overflow-hidden rounded-lg shadow transition hover:shadow-lg h-96">
              <Image
                ...
                height={1080}
              />
              <div className="relative pt-36 bg-gradient-to-t from-gray-900 to-slate-900/5 h-full">
                <div className="p-4 sm:p-6">
                  <div>
                    <h3 className="mt-0.5 text-white font-bold text-4xl">
                      Armada Trailer
